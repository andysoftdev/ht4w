...
namespace Hypertable.ThriftGen
{
  ...
  public partial class ScanSpec : TBase
  {
    ...
    private bool _and_column_predicates;
    ...
    public bool And_column_predicates
    {
      get
      {
        return _and_column_predicates;
      }
      set
      {
        __isset.and_column_predicates = true;
        this._and_column_predicates = value;
      }
    }
    ...
    public ScanSpec() {
      ...
      this._and_column_predicates = false;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 19:
              if (field.Type == TType.Bool) {
                And_column_predicates = iprot.ReadBool();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (__isset.and_column_predicates) {
          field.Name = "and_column_predicates";
          field.Type = TType.Bool;
          field.ID = 19;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(And_column_predicates);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("ScanSpec(");
      bool __first = true;
      if (Row_intervals != null && __isset.row_intervals) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Row_intervals: ");
        __sb.Append(Row_intervals);
      }
      if (Cell_intervals != null && __isset.cell_intervals) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Cell_intervals: ");
        __sb.Append(Cell_intervals);
      }
      if (__isset.return_deletes) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Return_deletes: ");
        __sb.Append(Return_deletes);
      }
      if (__isset.versions) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Versions: ");
        __sb.Append(Versions);
      }
      if (__isset.row_limit) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Row_limit: ");
        __sb.Append(Row_limit);
      }
      if (__isset.start_time) {
        if(!__first) { __sb.Append(", "); }
      ...
      if (__isset.keys_only) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Keys_only: ");
        __sb.Append(Keys_only);
      }
      if (__isset.cell_limit) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Cell_limit: ");
        __sb.Append(Cell_limit);
      }
      if (__isset.cell_limit_per_family) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Cell_limit_per_family: ");
        __sb.Append(Cell_limit_per_family);
      }
      if (Row_regexp != null && __isset.row_regexp) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Row_regexp: ");
        __sb.Append(Row_regexp);
      }
      if (Value_regexp != null && __isset.value_regexp) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Value_regexp: ");
        __sb.Append(Value_regexp);
      }
      if (__isset.scan_and_filter_rows) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Scan_and_filter_rows: ");
        __sb.Append(Scan_and_filter_rows);
      }
      if (__isset.row_offset) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Row_offset: ");
        __sb.Append(Row_offset);
      }
      if (__isset.cell_offset) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Cell_offset: ");
        __sb.Append(Cell_offset);
      }
      if (Column_predicates != null && __isset.column_predicates) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Column_predicates: ");
        __sb.Append(Column_predicates);
      }
      if (__isset.do_not_cache) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Do_not_cache: ");
        __sb.Append(Do_not_cache);
      }
      if (__isset.and_column_predicates) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("And_column_predicates: ");
        __sb.Append(And_column_predicates);
      }
      __sb.Append(")");
