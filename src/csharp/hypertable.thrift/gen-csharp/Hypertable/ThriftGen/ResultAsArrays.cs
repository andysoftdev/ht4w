...
namespace Hypertable.ThriftGen
{
  ...
  [Serializable]
  #endif
  public partial class ResultAsArrays : TBase
  {
    private int _error;
    ...
    public ResultAsArrays(bool is_empty, long id, bool is_scan, bool is_error) : this() {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("ResultAsArrays");
        ...
        if (Cells != null && __isset.cells) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (List<string> _iter26 in Cells)
            {
              {
                oprot.WriteListBegin(new TList(TType.String, _iter26.Count));
                foreach (string _iter27 in _iter26)
                {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("ResultAsArrays(");
