...
const char * Status::Text::SERVER_IS_COMING_UP = "Server is coming up";
const char * Status::Text::SERVER_IS_SHUTTING_DOWN = "Server is shutting down";
const char * Status::Text::STANDBY = "Standby";
