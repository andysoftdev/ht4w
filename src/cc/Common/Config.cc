...
void DefaultPolicy::init_options() {
  ...
  file_desc().add_options()
    ...
    ("FsBroker.Local.Embedded.AsyncIO", boo()->default_value(false),
    ...
    ("Hypertable.Service.Timeout.StartService", i32()->default_value(120000), "Start service timeout in ms")
    ("Hypertable.Service.Timeout.StopService", i32()->default_value(120000), "Stop service timeout in ms")
    ("Hypertable.Service.Timeout.StartServer", i32()->default_value(20000), "Start server timeout in ms")
