...
#define HT_LOG(priority, msg) do { \
  if (Logger::get()->is_enabled(priority)) { \
    if (Logger::get()->show_line_numbers() && priority != Hypertable::Logger::Priority::NOTICE) \
...
#define HT_OUT_DISABLED(priority) do { if (0) { \
  char logbuf[HT_LOG_BUF_SIZE]; \
  const int _priority_ = priority; \
  FixedOstream _out_(logbuf, sizeof(logbuf)); \
  _out_
...
#define HT_DEBUG_OUT HT_OUT_DISABLED(Logger::Priority::DEBUG)
#endif
...
#define HT_INFO(msg)
#define HT_INFOF(msg, ...)
#define HT_INFO_OUT HT_OUT_DISABLED(Logger::Priority::INFO)
#endif
...
#define HT_NOTICE_OUT HT_OUT_DISABLED(Logger::Priority::NOTICE)
#endif
...
#define HT_WARN(msg)
#define HT_WARNF(msg, ...)
#define HT_WARN_OUT HT_OUT_DISABLED(Logger::Priority::WARN)
#endif
...
#define HT_ERROR_OUT HT_OUT_DISABLED(Logger::Priority::ERROR)
#endif
...
#define HT_CRIT(msg)
#define HT_CRITF(msg, ...)
#define HT_CRIT_OUT HT_OUT_DISABLED(Logger::Priority::CRIT)
#endif
...
#define HT_ALERT_OUT HT_OUT_DISABLED(Logger::Priority::ALERT)
#endif
...
#define HT_EMERG_OUT HT_OUT_DISABLED(Logger::Priority::EMERG)
#endif
...
#define HT_FATAL_OUT HT_OUT_DISABLED(Logger::Priority::FATAL)
#endif
