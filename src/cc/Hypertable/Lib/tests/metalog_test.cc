...
#else
      HT_ASSERT(system("fc metalog_test.out metalog_test.golden") == 0);
#endif
    }
...
#else
      HT_ASSERT(system("fc metalog_test2.out metalog_test2.golden") == 0);
#endif
    }
...
#else
      HT_ASSERT(system("fc metalog_test3.out metalog_test3.golden") == 0);
#endif
    }
